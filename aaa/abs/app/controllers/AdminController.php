...
public function showStudents() {
    ...
    if ($search) {
        $students = $classModel->searchStudentsInClass($id_c, $search, $limit, $offset);
        $total = $classModel->countStudentsInClassBySearch($id_c, $search);
    } else {
        $students = $classModel->getStudentsPaginated($id_c, $limit, $offset);
        $total = $classModel->countStudentsInClass($id_c);
    }
